...
<?php $component->withAttributes([]); ?>
    <h1 class="text-2xl font-bold mb-4">Ítems disponibles para Docentes 🧑‍🏫</h1>
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="border px-2 py-1">
                        <form action="<?php echo e(route('reservas.docente_store', $item->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="number" name="cantidad" min="1" max="<?php echo e($item->cantidad); ?>" value="1" class="form-control w-16 inline">
