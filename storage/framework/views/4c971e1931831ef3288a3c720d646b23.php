...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-6 flex justify-center">
        <div class="bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-8 w-full max-w-2xl border border-gray-200 dark:border-gray-700">
            ...
            <form action="<?php echo e(route('report.generar')); ?>" method="GET" class="space-y-6">
                <!-- Tipo de informe -->
                <div>
                ...
                <div class="flex justify-center gap-4 pt-4">
                    ...
                    <a href="<?php echo e(route('report.formulario')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\jramo\sistema_inventario_laboratorios\resources\views/report/formulario.blade.php ENDPATH**/ ?>