...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(session('success')): ?>
        <div class="bg-green-200 text-green-800 p-2 rounded mb-3"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
        ...
        <tbody>
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <form action="<?php echo e(route('reservas.profesor_store', $item->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="number" name="cantidad" min="1" max="<?php echo e($item->cantidad); ?>" value="1"
